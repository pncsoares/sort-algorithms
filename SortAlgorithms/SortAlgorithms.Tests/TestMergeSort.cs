using System;
using SortAlgorithms.MergeSort;
using Xunit;
...
{
    private readonly MergeSortAlgorithm _sut = new();
    
    [Fact]
    public void Test_MergeSort_UnorderedArray()
    {
        // Arrange
    ...
    [Fact]
    public void Test_MergeSort_UnorderedArray_WithDuplicates()
    {
        // Arrange
    ...
    [Fact]
    public void Test_MergeSort_OrderedArray()
    {
        // Arrange
    ...
    [Fact]
    public void Test_MergeSort_OrderedArray_WithDuplicates()
    {
        // Arrange
    ...
    [Fact]
    public void Test_MergeSort_NullArray()
    {
        // Arrange
        int[] inputArray = null;
