...
{
    private readonly HeapSortAlgorithm _sut = new();
    
    [Fact]
    public void Test_HeapSort_UnorderedArray()
    {
        // Arrange
    ...
    [Fact]
    public void Test_HeapSort_UnorderedArray_WithDuplicates()
    {
        // Arrange
    ...
    [Fact]
    public void Test_HeapSort_OrderedArray()
    {
        // Arrange
    ...
    [Fact]
    public void Test_HeapSort_OrderedArray_WithDuplicates()
    {
        // Arrange
    ...
    [Fact]
    public void Test_HeapSort_EmptyArray()
    {
        // Arrange
    ...
    [Fact]
    public void Test_HeapSort_NullArray()
    {
        // Arrange
        int[] inputArray = null;
