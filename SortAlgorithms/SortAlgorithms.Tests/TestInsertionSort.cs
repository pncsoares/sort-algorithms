using System;
using SortAlgorithms.InsertionSort;
using Xunit;
...
{
    private readonly InsertionSortAlgorithm _sut = new();
    
    [Fact]
    public void Test_InsertionSort_UnorderedArray()
    {
        // Arrange
    ...
    [Fact]
    public void Test_InsertionSort_UnorderedArray_WithDuplicates()
    {
        // Arrange
    ...
    [Fact]
    public void Test_InsertionSort_OrderedArray()
    {
        // Arrange
    ...
    [Fact]
    public void Test_InsertionSort_OrderedArray_WithDuplicates()
    {
        // Arrange
    ...
    [Fact]
    public void Test_InsertionSort_NullArray()
    {
        // Arrange
        int[] inputArray = null;
